...
type
  _SYSTEM_INFORMATION_CLASS = (
    SystemBasicInformation,                   //   0 = 0x00000000
    SystemProcessorInformation,               //   1 = 0x00000001
    SystemPerformanceInformation,             //   2 = 0x00000002
    SystemTimeOfDayInformation,               //   3 = 0x00000003
    SystemNotImplemented1,                    //   4 = 0x00000004
    SystemProcessesAndThreadsInformation,     //   5 = 0x00000005
    SystemCallCounts,                         //   6 = 0x00000006
    SystemConfigurationInformation,           //   7 = 0x00000007
    SystemProcessorTimes,                     //   8 = 0x00000008
    SystemGlobalFlag,                         //   9 = 0x00000009
    SystemNotImplemented2,                    //  10 = 0x0000000A
    SystemModuleInformation,                  //  11 = 0x0000000B
    SystemLockInformation,                    //  12 = 0x0000000C
    SystemNotImplemented3,                    //  13 = 0x0000000D
    SystemNotImplemented4,                    //  14 = 0x0000000E
    SystemNotImplemented5,                    //  15 = 0x0000000F
    SystemHandleInformation,                  //  16 = 0x00000010
    SystemObjectInformation,                  //  17 = 0x00000011
    SystemPagefileInformation,                //  18 = 0x00000012
    SystemInstructionEmulationCounts,         //  19 = 0x00000013
    SystemInvalidInfoClass1,                  //  20 = 0x00000014
    SystemCacheInformation,                   //  21 = 0x00000015
    SystemPoolTagInformation,                 //  22 = 0x00000016
    SystemProcessorStatistics,                //  23 = 0x00000017
    SystemDpcInformation,                     //  24 = 0x00000018
    SystemNotImplemented6,                    //  25 = 0x00000019
    SystemLoadImage,                          //  26 = 0x0000001A
    SystemUnloadImage,                        //  27 = 0x0000001B
    SystemTimeAdjustment,                     //  28 = 0x0000001C
    SystemNotImplemented7,                    //  29 = 0x0000001D
    SystemNotImplemented8,                    //  30 = 0x0000001E
    SystemNotImplemented9,                    //  31 = 0x0000001F
    SystemCrashDumpInformation,               //  32 = 0x00000020
    SystemExceptionInformation,               //  33 = 0x00000021
    SystemCrashDumpStateInformation,          //  34 = 0x00000022
    SystemKernelDebuggerInformation,          //  35 = 0x00000023
    SystemContextSwitchInformation,           //  36 = 0x00000024
    SystemRegistryQuotaInformation,           //  37 = 0x00000025
    SystemLoadAndCallImage,                   //  38 = 0x00000026
    SystemPrioritySeparation,                 //  39 = 0x00000027
    SystemNotImplemented10,                   //  40 = 0x00000028
    SystemNotImplemented11,                   //  41 = 0x00000029
    SystemInvalidInfoClass2,                  //  42 = 0x0000002A
    SystemInvalidInfoClass3,                  //  43 = 0x0000002B
    SystemTimeZoneInformation,                //  44 = 0x0000002C
    SystemLookasideInformation,               //  45 = 0x0000002D
    SystemSetTimeSlipEvent,                   //  46 = 0x0000002E
    SystemCreateSession,                      //  47 = 0x0000002F
    SystemDeleteSession,                      //  48 = 0x00000030
    SystemInvalidInfoClass4,                  //  49 = 0x00000031
    SystemRangeStartInformation,              //  50 = 0x00000032
    SystemVerifierInformation,                //  51 = 0x00000033
    SystemAddVerifier,                        //  52 = 0x00000034
    SystemSessionProcessesInformation);       //  53 = 0x00000035
...
type
  _FILE_FS_VOLUME_INFORMATION = record
    ...
    Unknown: UCHAR;
    VolumeLabel: array[0..511] of WCHAR;
  end;
  ...
  _FILE_FS_ATTRIBUTE_INFORMATION = record
    ...
    FileSystemName: array[0..511] of WCHAR
  end;
...
type
  ...
  _FILE_STREAM_INFORMATION = record // Information Class 22
    ...
    AllocationSize: LARGE_INTEGER;
    StreamName: array[0..511] of WCHAR;
  end;
